...
?>
    ...
    <body>
            ...
            <header>
                <div class="d-flex flex-column flex-md-row align-items-center pb-3 mb-4 border-bottom">
                    ...
                    <nav class="d-inline-flex mt-2 mt-md-0 ms-md-auto">
                        ...
                        <a class="py-2 link-body-emphasis text-decoration-none" href="../login/index.html">Login</a>
                    </nav>
                </div>
            </header>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form id="cambiarPasswordForm">
                                        ...
                                        <div class="form-group">
                                            <label for="retipearPassword">Reingrese Contraseña:</label>
                                            <input type="password" class="form-control" id="retipearPassword" name="retipearPassword" required>
                                        </div>
                                        <button type="submit" class="btn btn-primary">Cambiar</button>
                                        <button type="button" class="btn btn-secondary" id="irAlLogin">Ir al Login</button>
                                    </form>
                                </div>
                            </div>
                        </div>
            ...
            <div class="container fixed-bottom">
                <footer class="py-3 my-4 sticky-bottom">
                    <ul class="nav justify-content-center border-bottom pb-3 mb-3">
                        ...
                        <li class="nav-item"><a href="contacto.php" class="nav-link px-2 text-body-secondary">Contacto</a>
                        </li>
        ...
        <script src="autenticar_usuario.js"></script>
    </body>

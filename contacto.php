        ...
        <main>
            <div class="container my-5">
                <div class="position-relative p-5 text-center text-muted bg-body border border-dashed rounded-5">
                    <h1 class="text-body-emphasis">"¡Conéctate con Nosotros!"</h1>
                    <p class="col-lg-12 mx-auto mb-4">
                        ¡Estamos encantados de saber de ti! En Gustech Store, valoramos la opinión y las preguntas de
                        nuestros clientes. Si tienes alguna consulta sobre nuestros productos, sugerencias para mejorar
                        tu experiencia de compra, o simplemente deseas saludarnos, no dudes en ponerte en contacto.
                        Nuestro equipo está aquí para ayudarte. ¡Esperamos con entusiasmo tu mensaje y haremos todo lo
                        posible para responderte tan pronto como sea posible! ¡Gracias por ser parte de nuestra
                        comunidad de compras en línea!
                    </p>
